setlanguage:
  if(Language = "FR"){
    ...
    tray_vdgrid=Définir l'odre de la VD grille...
    ...
    input_vdgrid_title=Entrez un ordre pour le défilement des différentes VD grilles
    input_gridorder=Il suffit d'entrer les noms comme ils le sont dans le menu "Modèles", separés par des virgules ','.
    input_vdgrid=Il suffit d'entrer les noms comme ils le sont dans le menu "Modèles", separés par des virgules ','.
    ...
    tray_vdgrid=Set Virtual Desktop Grid...
    ...
    input_vdgrid_title=Input an order for the VD Grid
    input_gridorder=Just type the names as found in the "templates" menu item`, separated by commas '`,'.
    input_vdgrid=Just type the names as found in the "templates" menu item`, separated by commas '`,'.
